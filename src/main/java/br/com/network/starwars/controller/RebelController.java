...
public class RebelController {
    ...
    public GenericResponse create(@Valid @RequestBody RebelVO obj) {
        ...
        return new GenericResponse(messages.getMessage("message.rebel.created", null, null), created);
    }
    ...
    public GenericResponse reportTraitor(@PathVariable("id") Long id, @Valid @RequestBody ReportDTO obj) throws Exception {
        ...
        return new GenericResponse(messages.getMessage("message.rebel.reportTraitor", null, null), created);
    }
    ...
    public GenericResponse updateLocation(@PathVariable("id") Long id, @Valid @RequestBody LocationVO obj) {
        ...
        return new GenericResponse(messages.getMessage("message.rebel.locationUpdated", null, null), created);
    }
